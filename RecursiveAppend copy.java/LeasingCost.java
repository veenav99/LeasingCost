public class LeasingCost {
    ...
    */
    ...
    public static double computeFuelCost(double numberOfMonth, double usage, double mileageAllowance, double fuelPrice){
        double distance = numberOfMonth * mileageAllowance;
        double Totalcost = distance / usage * fuelPrice;
        return Totalcost;
    }
    ...
    public static Vehicle createVehicle(String description){
        ...
        Vehicle BrandNewCar = new Vehicle (name,fuel, lease);

        return BrandNewCar;
    }
  
    public static String getname(String s, String description){
        String string = description.substring(description.indexOf(s) + String.valueOf(s).length(), description.indexOf(';', description.indexOf(s)));
        return string;
    }
